...
3. Copy the API endpoint URL identified at step 2 and paste it in the .env file as `REACT_APP_API_ENDPOINT=<http://...>`.
4. Build the (using `npm run build`) app for distribution
